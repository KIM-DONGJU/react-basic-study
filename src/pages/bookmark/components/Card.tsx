    ...
    <div className={styles.card}>
      ...
      <div className={styles.card__infoBox}>
        <div className={styles.card__infoBox__row}>
          ...
          <span className={styles.value}>{card.user.name}</span>
        </div>
        <div className={styles.card__infoBox__row}>
        ...
        <div className={styles.card__infoBox__row}>
          ...
          <span className={styles.value}>{card.created_at.split('T')[0]}</span>
        </div>
        <div className={styles.card__infoBox__row}>
          <span className={styles.label}>마지막 업데이트</span>
          <span className={styles.value}>{card.updated_at.split('T')[0]}</span>
        </div>
        <div className={styles.card__infoBox__row}>
          <span className={styles.label}>다운로드 수</span>
          <span className={styles.value}>{card.likes}</span>
        </div>
      </div>
    </div>
  )
